...
import com.wqlin.widget.flexbox.*
import java.util.*
...
internal class FragmentHelper(private val activity: MainActivity, private val flexContainer: FlexContainer) {
    ...
    fun setFlexItemAttributes(flexItem: FlexItem): FlexItem {
        ...
        list.add(200)
        val random = Random()
        val next = random.nextInt(8)
        flexItem.width = list[next]//activity.dpToPixel(readPreferenceAsInteger(activity.getString(R.string.new_width_key), DEFAULT_WIDTH))
        ...
        flexItem.flexGrow = 1F //readPreferenceAsFloat(activity.getString(R.string.new_flex_grow_key), "0.f0")
